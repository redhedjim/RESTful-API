...
mongoose.connect('mongodb://leo:1q2w3e4r@apollo.modulusmongo.net:27017/rYja5zir');
//APP CONFIGURATION
//================================

//use body parser so we ca grab information from POST requests
...
apiRouter.use(function(req, res, next) {
    ...
    apiRouter.use(function(req, res, next){
        ...
        //decode token
        if (token) {
            //verifies sewcret and checks exp
...
apiRouter.get('/', function(req, res){
    res.json({ message: 'Hooray!!! Welcome to our API, Mel!' });
});
